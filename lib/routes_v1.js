...
routesV1.identifications_species_counts = function( req, res ) {
  util.setTTL( req );
  IdentificationsController.speciesCounts( req, { }, function( err, data ) {
    util.renderJSONPresponse( req, res, err, data );
  } );
};
...
routesV1.search_index = function( req, res ) {
  req.query.ttl = req.query.ttl || 300;
  SearchController.search( req, function( err, data ) {
    util.renderJSONPresponse( req, res, err, data );
  });
};
