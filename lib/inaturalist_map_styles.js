...
InaturalistMapStyles.coloredHeatmap = function( color ) {
  return "\
  <Style name='style' opacity='0.8'>\
    <Rule>\
      <MarkersSymbolizer multi-policy='whole' width='14' stroke='#ffffff' stroke-width='2' fill='"+ color +"' fill-opacity='0.35' placement='point' marker-type='ellipse' allow-overlap='true' comp-op='darken' />\
    </Rule>\
  </Style>";
};

InaturalistMapStyles.greySummary = function( ) {
  return "\
  <Style name='style' image-filters='colorize-alpha(#6E6E6E)' opacity='0.8'>\
    <Rule>\
      <MarkersSymbolizer multi-policy='whole' width='8' stroke-width='0' fill='#6E6E6E' fill-opacity='0.4' placement='point' marker-type='ellipse' allow-overlap='true' comp-op='screen' />\
    </Rule>\
  </Style>";
};
...
InaturalistMapStyles.grid = function( ) {
  ...
  <Style name='style'>\
    <Rule>\
      <LineSymbolizer stroke='#6e6e6e' stroke-opacity='0.4' />\
      <PolygonSymbolizer fill='#6e6e6e' fill-opacity='0.9' />\
    </Rule>\
  </Style>";
};
