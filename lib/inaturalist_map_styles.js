...
InaturalistMapStyles.coloredPoints = function( color ) {
  ...
  return InaturalistMapStyles.extractMMLStyle(
    ...
    "marker-allow-overlap: true; " +
    "[quality_grade='research'] { marker-line-color: #ffffff; } " +
    "[zoom >= 16] { marker-width: 9; marker-line-width: 1.5; } " +
    "[zoom >= 17] { marker-width: 10; marker-line-width: 1.5; } " +
    "[zoom >= 18] { marker-width: 12; marker-line-width: 1.5; } " +
    "[zoom >= 19] { marker-width: 16; marker-line-width: 2; } " +
    "[zoom >= 20] { marker-width: 20; marker-line-width: 2.5; } "
  );
};

InaturalistMapStyles.markersAndCircles = function( ) {
  var style = InaturalistMapStyles.extractMMLStyle(
    "marker-fill: #585858; " +
    "marker-width: 8; " +
    "marker-line-color: #ffffff; " +
    ...
    "marker-allow-overlap: true; " +
    "marker-file: 'lib/assets/rounded_marker.svg'; " +
    "marker-transform: translate(0,3); " +
    InaturalistMapStyles.taxonColorCSS( ) +
    "[captive='true'] { marker-fill-opacity: 0.3; marker-line-opacity: 0.4; } " +
    "[mappable='false'],[private_location!=''] { marker-file: ''; marker-line-width: 1.5; marker-transform: translate(0,0); "+
    "marker-width: 10; marker-line-color: #BDBDBD; marker-fill-opacity: 0.3; } " +
    "[quality_grade='research'] { fg/marker-line-width: 0; fg/marker-width: 2; fg/marker-fill: #ffffff; " +
    "fg/marker-fill-opacity: 1; fg/marker-allow-overlap: true; }"
  );
  return style;
  ...
  //     <MarkersSymbolizer multi-policy='whole' width='4' fill='#73ac13' fill-opacity='1' stroke='#ffffff' stroke-width='1' stroke-opacity='1' placement='point' marker-type='ellipse' allow-overlap='true' comp-op='src' />\
  //     <MarkersSymbolizer file='lib/assets/rounded_marker.svg' transform='translate(0,-13)' allow-overlap='true' opacity='1.0' stroke='#ffffff' stroke-width='150' stroke-opacity='0.7' width='8' fill='#73ac13'/>\
  //   </Rule>\
  //   <Rule>\
