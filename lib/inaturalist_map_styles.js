...
InaturalistMapStyles.colorHeatmap = function( color ) {
  color = color || "#6E6E6E";
  return "\
  <Style name='style' image-filters='colorize-alpha(" + color + ")' opacity='0.8'>\
    <Rule>\
      <MarkersSymbolizer multi-policy='whole' width='8' stroke-width='0' fill='" + color + "' fill-opacity='0.4' placement='point' marker-type='ellipse' allow-overlap='true' comp-op='screen' />\
    </Rule>\
  </Style>";
};
