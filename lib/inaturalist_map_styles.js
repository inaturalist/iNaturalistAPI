...
InaturalistMapStyles.places = function( ) {
  ...
  <Style name='style' filter-mode='first'>\
    <Rule>\
      <PolygonSymbolizer fill='#daa520' fill-opacity='0.3' />\
      <LineSymbolizer stroke-width='2' stroke-opacity='0.9' stroke='#daa520' />\
    </Rule>\
  </Style>";
};
...
InaturalistMapStyles.taxonRange = function( color ) {
  ...
  <Style name='style' filter-mode='first'>\
    <Rule>\
      <PolygonSymbolizer fill='"+ color +"' fill-opacity='0.4' />\
      <LineSymbolizer stroke-width='1' stroke-opacity='0.9' stroke='"+ color +"' />\
    </Rule>\
  </Style>";
};
...
InaturalistMapStyles.taxonPlaces = function( ) {
  ...
  <Style name='style' filter-mode='first'>\
    <Rule>\
      <Filter>([establishment_means] = 'introduced') and ([occurrence_status_level] = 10)</Filter>\
      <PolygonSymbolizer fill='#2e2e2e' fill-opacity='0.3' />\
      <LineSymbolizer stroke-dasharray='10, 6' stroke='#2e2e2e' stroke-width='1' stroke-opacity='0.9' />\
    </Rule>\
    <Rule>\
      <Filter>([establishment_means] = 'introduced') and ([last_observation_id] &gt; 0)</Filter>\
      <PolygonSymbolizer fill='#73ac13' fill-opacity='0.3' />\
      <LineSymbolizer stroke-dasharray='10, 6' stroke='#73ac13' stroke-width='1' stroke-opacity='0.9' />\
    </Rule>\
    <Rule>\
      <Filter>([establishment_means] = 'introduced')</Filter>\
      <PolygonSymbolizer fill='#daa520' fill-opacity='0.3' />\
      <LineSymbolizer stroke-dasharray='10, 6' stroke-width='1' stroke-opacity='0.9' stroke='#daa520' />\
    </Rule>\
    <Rule>\
      <Filter>([occurrence_status_level] = 10)</Filter>\
      <PolygonSymbolizer fill='#2e2e2e' fill-opacity='0.3' />\
      <LineSymbolizer stroke='#2e2e2e' stroke-width='1' stroke-opacity='0.9' />\
    </Rule>\
    <Rule>\
      <Filter>([last_observation_id] &gt; 0)</Filter>\
      <PolygonSymbolizer fill='#73ac13' fill-opacity='0.3' />\
      <LineSymbolizer stroke='#73ac13' stroke-width='1' stroke-opacity='0.9' />\
    </Rule>\
    <Rule>\
      <PolygonSymbolizer fill='#daa520' fill-opacity='0.3' />\
      <LineSymbolizer stroke-width='1' stroke-opacity='0.9' stroke='#daa520' />\
    </Rule>\
  </Style>";
};
...
InaturalistMapStyles.markersAndCircles = function( ) {
  return "\
  <Style name='style' filter-mode='first'>\
    <Rule>\
      <Filter>([taxon.iconic_taxon_id] = 47158)</Filter>\
      <MarkersSymbolizer file='lib/assets/rounded_marker.svg' allow-overlap='true' opacity='1.0' stroke='#ffffff' stroke-width='150' stroke-opacity='0.7' width='7' fill='#ff4500'/>\
    </Rule>\
    <Rule>\
      <Filter>([taxon.iconic_taxon_id] = 40151)</Filter>\
      <MarkersSymbolizer file='lib/assets/rounded_marker.svg' allow-overlap='true' opacity='1.0' stroke='#ffffff' stroke-width='150' stroke-opacity='0.7' width='7' fill='#1e90ff'/>\
    </Rule>\
    <Rule>\
    ...
    <Rule>\
      ...
      <MarkersSymbolizer file='lib/assets/rounded_marker.svg' allow-overlap='true' opacity='1.0' stroke='#d8d8d8' stroke-width='150' stroke-opacity='0.7' width='7' fill='#8b008b'/>\
    </Rule>\
    <Rule>\
      <Filter>([taxon.iconic_taxon_id] = 48222)</Filter>\
      <MarkersSymbolizer file='lib/assets/rounded_marker.svg' allow-overlap='true' opacity='1.0' stroke='#ffffff' stroke-width='150' stroke-opacity='0.7' width='7' fill='#993300'/>\
    </Rule>\
    <Rule>\
      <Filter>([taxon.iconic_taxon_id] = 47178)</Filter>\
      <MarkersSymbolizer file='lib/assets/rounded_marker.svg' allow-overlap='true' opacity='1.0' stroke='#d8d8d8' stroke-width='150' stroke-opacity='0.7' width='7' fill='#1e90ff'/>\
    </Rule>\
    <Rule>\
      <Filter>([taxon.iconic_taxon_id] = 47170)</Filter>\
      <MarkersSymbolizer file='lib/assets/rounded_marker.svg' allow-overlap='true' opacity='1.0' stroke='#ffffff' stroke-width='150' stroke-opacity='0.7' width='7' fill='#ff1493'/>\
    </Rule>\
    <Rule>\
      <Filter>([taxon.iconic_taxon_id] = 47126)</Filter>\
      <MarkersSymbolizer file='lib/assets/rounded_marker.svg' transform='translate(0,3)' allow-overlap='true' opacity='1.0' stroke='#ffffff' stroke-width='150' stroke-opacity='0.7' width='8' fill='#73ac13'/>\
      <MarkersSymbolizer multi-policy='whole' width='3' stroke-width='0' fill='#3D3D3D' fill-opacity='1' placement='point' marker-type='ellipse' allow-overlap='true' comp-op='src' />\
    </Rule>\
    <Rule>\
    ...
    <Rule>\
      ...
      <MarkersSymbolizer stroke='#004180' multi-policy='whole' width='10' stroke-width='2' fill='#1e90ff' fill-opacity='1' stroke-opacity='0.7' placement='point' marker-type='ellipse' allow-overlap='true' comp-op='src' />\
      <MarkersSymbolizer stroke='#ffffff' multi-policy='whole' width='2' stroke-width='0' fill='#ffffff' fill-opacity='1'placement='point' marker-type='ellipse' allow-overlap='true' comp-op='src' />\
    </Rule>\
    <Rule>\
    ...
    <Rule>\
      <MarkersSymbolizer file='lib/assets/rounded_marker.svg' allow-overlap='true' opacity='1.0' stroke='#ffffff' stroke-width='150' stroke-opacity='0.7' width='7' fill='#585858'/>\
    </Rule>\
  </Style>";
};
