...
InaturalistAPI.server = function( ) {
  ...
  app.post( "/v1/observation_field_values", ( req, res ) => {
    routesV1.default( ObservationFieldValuesContoller.create, req, res );
  });
  app.put( "/v1/observation_field_values/:id", ( req, res ) => {
    routesV1.default( ObservationFieldValuesContoller.update, req, res );
  });
  app.delete( "/v1/observation_field_values/:id", ( req, res ) => {
    routesV1.default( ObservationFieldValuesContoller.delete, req, res );
  });
