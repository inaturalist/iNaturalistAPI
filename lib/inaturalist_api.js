...
InaturalistAPI.server = ( ) => {
  ...
  const UserMutesController = require( "./controllers/v1/user_mutes_controller" );
  ...
  // UserMutes
  dfault( "post", "/v1/user_mutes", UserMutesController.create );
  dfault( "delete", "/v1/user_mutes/:id", UserMutesController.delete );
