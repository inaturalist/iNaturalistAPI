...
InaturalistAPI.preloadAndProcess = ( method, req, res, opts = { } ) => {
  ...
  if ( req.userSession && req.userSession.user_id && !_.isEmpty( options.preload ) ) {
    ...
    if ( options.preload.trustingUsers ) {
      User.trustingUsers( req.userSession.user_id, ( err, userIDs ) => {
        if ( userIDs ) {
    ...
    if ( options.preload.siteID ) {
      User.siteID( req.userSession.user_id, ( err, siteID ) => {
        if ( siteID ) {
...
InaturalistAPI.server = ( ) => {
  ...
  const dfault = ( action, path, method, options = { } ) => {
  ...
  // Observations
  dfault( "post", "/v1/observations", ObservationsController.create, { async: true } );
  dfault( "put", "/v1/observations/:id", ObservationsController.update, { async: true } );
  dfault( "delete", "/v1/observations/:id", ObservationsController.delete, { async: true } );
  dfault( "get", "/v1/observations", ObservationsController.searchCacheWrapper,
    { async: true, defaultTTL: 300, preload: allPreloads } );
  dfault( "get", "/v1/observations/identifiers", ObservationsController.identifiersCacheWrapper,
    { async: true, setTTL: true, preload: allPreloads } );
  ...
  dfault( "get", "/v1/observations/species_counts", ObservationsController.speciesCountsCacheWrapper,
    { async: true, setTTL: true, preload: { localeDefaults: true } } );
  dfault( "get", "/v1/observations/taxa_counts_by_month", ObservationsController.taxaCountsByMonth,
    { async: true, setTTL: true, preload: { localeDefaults: true } } );
  dfault( "get", "/v1/observations/popular_field_values", ObservationsController.popularFieldValues, { async: true } );
  dfault( "get", "/v1/observations/histogram", ObservationsController.histogram, { async: true } );
  dfault( "get", "/v1/observations/iconic_taxa_counts", ObservationsController.iconicTaxaCounts, { async: true } );
  dfault( "get", "/v1/observations/iconic_taxa_species_counts", ObservationsController.iconicTaxaSpeciesCounts, { async: true } );
  dfault( "get", "/v1/observations/tree_taxa", ObservationsController.treeTaxa, { async: true } );
  dfault( "get", "/v1/observations/taxonomy", ObservationsController.taxonomy, { async: true } );
  dfault( "get", "/v1/observations/lifelist_export", ObservationsController.lifelistExport, { async: true } );
  dfault( "get", "/v1/observations/updates", ObservationsController.updates, { async: true } );
  dfault( "get", "/v1/observations/deleted", ObservationsController.deleted, { async: true } );
  dfault( "get", "/v1/observations/umbrella_project_stats", ObservationsController.umbrellaProjectStats, { async: true } );
  dfault( "get", "/v1/observations/quality_grades", ObservationsController.qualityGrades, { async: true } );
  dfault( "get", "/v1/observations/identification_categories", ObservationsController.identificationCategories, { async: true } );
  dfault( "get", "/v1/observations/similar_species", ObservationsController.similarSpecies, { async: true } );
  ...
  dfault( "post", "/v1/observations/:id/fave", ObservationsController.fave, { async: true } );
  dfault( "delete", "/v1/observations/:id/unfave", ObservationsController.unfave, { async: true } );
  dfault( "post", "/v1/votes/vote/observation/:id", ObservationsController.fave, { async: true } );
  dfault( "delete", "/v1/votes/unvote/observation/:id", ObservationsController.unfave, { async: true } );
  dfault( "post", "/v1/observations/:id/review", ObservationsController.review, { async: true } );
  dfault( "delete", "/v1/observations/:id/review", ObservationsController.unreview, { async: true } );
  dfault( "post", "/v1/observations/:id/quality/:metric", ObservationsController.setQualityMetric, { async: true } );
  dfault( "delete", "/v1/observations/:id/quality/:metric", ObservationsController.deleteQualityMetric, { async: true } );
  dfault( "get", "/v1/observations/:id/quality_metrics", ObservationsController.qualityMetrics, { async: true } );
  dfault( "get", "/v1/observations/:id/subscriptions", ObservationsController.subscriptions, { async: true } );
  dfault( "get", "/v1/observations/:id/taxon_summary", ObservationsController.taxonSummary, { async: true } );
  dfault( "put", "/v1/observations/:id/viewed_updates", ObservationsController.viewedUpdates, { async: true } );
  ...
  dfault( "delete", "/v1/projects/:id", ProjectsController.delete, { async: true } );
  dfault( "get", "/v1/projects/:id", ProjectsController.show,
    { async: true, validateMultiIDParam: true, allowIDSlugs: true } );
  dfault( "get", "/v1/projects/:id/members", ProjectsController.members,
    { async: true, validateMultiIDParam: true, allowIDSlugs: true } );
  dfault( "get", "/v1/projects/:id/posts", ProjectsController.posts, { async: true } );
  dfault( "post", "/v1/projects/:id/join", ProjectsController.join, { async: true, validateMultiIDParam: true } );
  dfault( "delete", "/v1/projects/:id/leave", ProjectsController.leave, { async: true, validateMultiIDParam: true } );
  dfault( "post", "/v1/projects/:id/add", ProjectsController.add, { async: true } );
  dfault( "delete", "/v1/projects/:id/remove", ProjectsController.remove, { async: true } );
  dfault( "get", "/v1/projects/:id/subscriptions", ProjectsController.subscriptions, { async: true } );
  dfault( "get", "/v1/projects/:id/followers", ProjectsController.followers, { async: true } );
  dfault( "put", "/v1/projects/:id/feature", ProjectsController.feature, { async: true } );
  dfault( "put", "/v1/projects/:id/unfeature", ProjectsController.unfeature, { async: true } );

  // Comments
  dfault( "post", "/v1/comments", CommentsController.create, { async: true } );
  dfault( "put", "/v1/comments/:id", CommentsController.update, { async: true } );
  dfault( "delete", "/v1/comments/:id", CommentsController.delete, { async: true } );

  // Flags
  dfault( "post", "/v1/flags", FlagsController.create, { async: true } );
  dfault( "delete", "/v1/flags/:id", FlagsController.delete, { async: true } );

  // Identifications
  dfault( "get", "/v1/identifications", IdentificationsController.search,
    { async: true, preload: allPreloads } );
  dfault( "post", "/v1/identifications", IdentificationsController.create, { async: true } );
  ...
  dfault( "get", "/v1/identifications/observers", IdentificationsController.observers,
    { async: true, preload: allPreloads } );
  dfault( "get", "/v1/identifications/recent_taxa", IdentificationsController.recentTaxaRevisited,
    { preload: { localeDefaults: true } } );
  dfault( "get", "/v1/identifications/recent_taxa_revisited", IdentificationsController.recentTaxaRevisited,
    { preload: { localeDefaults: true } } );
  ...
  dfault( "get", "/v1/identifications/:id", IdentificationsController.show,
    { async: true, preload: allPreloads } );
  dfault( "put", "/v1/identifications/:id", IdentificationsController.update, { async: true } );
  dfault( "delete", "/v1/identifications/:id", IdentificationsController.delete, { async: true } );

  // Messages
  dfault( "post", "/v1/messages", MessagesController.create, { async: true } );
  dfault( "delete", "/v1/messages/:id", MessagesController.delete, { async: true } );
  dfault( "get", "/v1/messages", MessagesController.index, { async: true } );
  dfault( "get", "/v1/messages/unread", MessagesController.unread, { async: true } );
  dfault( "get", "/v1/messages/:id", MessagesController.show, { async: true } );

  // ObservationFields
  dfault( "get", "/v1/observation_fields/autocomplete", ObservationFieldsController.autocomplete, { async: true } );
  dfault( "post", "/v1/observation_field_values", ObservationFieldValuesController.create, { async: true } );
  dfault( "put", "/v1/observation_field_values/:id", ObservationFieldValuesController.update, { async: true } );
  dfault( "delete", "/v1/observation_field_values/:id", ObservationFieldValuesController.delete, { async: true } );

  // Photos
  dfault( "post", "/v1/photos", PhotosController.create, { async: true } );

  // Sounds
  dfault( "post", "/v1/sounds", SoundsController.create, { async: true } );

  // Users
  dfault( "get", "/v1/users/autocomplete", UsersController.autocomplete, { async: true } );
  dfault( "put", "/v1/users/update_session", UsersController.updateSession, { async: true } );
  dfault( "put", "/v1/users/:id", UsersController.update, { async: true } );
  dfault( "get", "/v1/users/me", UsersController.me, { async: true } );
  dfault( "get", "/v1/users/:id", UsersController.show, { async: true } );
  dfault( "get", "/v1/users/:id/projects", UsersController.projects, { async: true } );
  dfault( "get", "/v1/users/:id/followees", UsersController.followees, { async: true } );
  dfault( "get", "/v1/users/:id/place_and_taxon_subscriptions", UsersController.placeAndTaxonSubscriptions,
    { async: true } );

  // Posts
  dfault( "get", "/v1/posts", PostsController.index, { async: true } );
  dfault( "get", "/v1/posts/for_user", PostsController.for_user, { async: true } );

  // Subscriptions
  dfault( "post", "/v1/subscriptions/Observation/:id/subscribe", ObservationsController.subscribe, { async: true } );
  dfault( "post", "/v1/subscriptions/Project/:id/subscribe", ProjectsController.subscribe, { async: true } );

  // ControlledTerms
  dfault( "get", "/v1/controlled_terms", ControlledTermsController.search, { async: true } );
  dfault( "get", "/v1/controlled_terms/for_taxon", ControlledTermsController.forTaxon, { async: true } );

  // Annotations
  dfault( "post", "/v1/annotations", AnnotationsController.create, { async: true } );
  dfault( "delete", "/v1/annotations/:id", AnnotationsController.delete, { async: true } );
  dfault( "post", "/v1/votes/vote/annotation/:id", AnnotationsController.vote, { async: true } );
  dfault( "delete", "/v1/votes/unvote/annotation/:id", AnnotationsController.unvote, { async: true } );

  // ProjectObservations
  dfault( "post", "/v1/project_observations", ProjectObservationsController.create, { async: true } );
  dfault( "put", "/v1/project_observations/:id", ProjectObservationsController.update, { async: true } );
  dfault( "delete", "/v1/project_observations/:id", ProjectObservationsController.delete, { async: true } );

  // Universal search
  dfault( "get", "/v1/search", SearchController.search,
    { async: true, defaultTTL: 120, preload: { localeDefaults: true } } );

  // Sites
  dfault( "get", "/v1/sites", SitesController.index, { async: true } );
  ...
  setTimeout( ( ) => {
    ...
    TaxaController.fetchSeekExceptionList( ( ) => { } );
  }, 1000 );
