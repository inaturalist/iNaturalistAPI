...
InaturalistAPI.server = async ( ) => {
  ...
  const TaxonNamePreferencesController = require( "./controllers/v1/taxon_name_preferences_controller" );
  ...
  dfault( "post", "/v1/taxon_name_preferences", TaxonNamePreferencesController.create );
  dfault( "put", "/v1/taxon_name_preferences/:id", TaxonNamePreferencesController.update );
  dfault( "delete", "/v1/taxon_name_preferences/:id", TaxonNamePreferencesController.delete );
