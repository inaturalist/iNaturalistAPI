...
InaturalistAPI.server = function( ) {
  ...
  app.post( "/v1/observations/:id/unreview", routesV1.observations_unreview );
  ...
  app.post( "/v1/comments", routesV1.comments_create );
  app.put( "/v1/comments/:id", routesV1.comments_update );
  app.delete( "/v1/comments/:id", routesV1.comments_delete );
  app.post( "/v1/identifications", routesV1.identifications_create );
  app.put( "/v1/identifications/:id", routesV1.identifications_update );
  app.delete( "/v1/identifications/:id", routesV1.identifications_delete );
...
InaturalistAPI.iNatJSWrap = function( method, req ) {
  ...
  var options = { rails: true, api_token: req.headers.authorization };
