...
InaturalistAPI.server = function( ) {
  ...
  dfault( "get", "/v1/identifications/new_taxa", IdentificationsController.newTaxa );
  dfault( "get", "/v1/identifications/related_species", IdentificationsController.relatedSpecies );
