...
InaturalistAPI.server = function( ) {
  ...
  app.get( "/observations", routesV1.observations_index );
  app.get( "/observations/identifiers", routesV1.observations_identifiers );
  app.get( "/observations/observers", routesV1.observations_observers );
  app.get( "/observations/species_counts", routesV1.species_counts );
  app.get( "/observations/:id", routesV1.observations_show );
  app.get( "/taxa/autocomplete", routesV1.taxa_autocomplete );
  app.get( "/taxa/:id", routesV1.taxa_show );
  app.get( "/places/nearby", routesV1.places_nearby );
  app.get( "/places/:id", routesV1.places_show );
