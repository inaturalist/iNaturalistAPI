...
InaturalistAPI.placesNearby = function( req, callback ) {
  ...
  if( req.query.swlat ) {
    ...
    latOffsetPx = latDiff * 0.2;
    lngOffsetPx = lngDiff * 0.2;
    ...
    var xyx = SphericalMercator.xyz([req.query.lng, req.query.lat, req.query.lng, req.query.lat], req.query.zoom);
    var bbox = SphericalMercator.bbox(xyx.minX, xyx.minY, req.query.zoom);
    req.query.swlng = bbox[ 0 ];
    req.query.swlat = bbox[ 1 ];
    req.query.nelng = bbox[ 2 ];
    req.query.nelat = bbox[ 3 ];
  }
