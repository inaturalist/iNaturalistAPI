...
var CVStats = class CVStats {
  ...
  scoreThisImage( ti, options ) {
    ...
    return new Promise( ( resolve, reject ) => {
      ...
      ImageCache.cacheURL( url, fileName, ( err, path ) => {
        ...
        let body = options.body ? Object.assign( { }, options.body ) : { };
  ...
  getStats( ) {
    ...
    return {
      ...
      withCommonAncestor: withCommonAncestor,
      withRightCommonAncestor: withRightCommonAncestor,
      averageAncestorRankLevel: CVStats.mean( allAncestorRankLevels ),
      countsOfEachIndex: countsOfEachIndex,
      countsOfEachAncestorRank: countsOfEachAncestorRank
    };
  }
  ...
  printStats( ) {
    ...
    let ancestorRankLevels = _.keys( stats.countsOfEachAncestorRank );
  ...
  static statsOutput( results ) {
    ...
    const withRight = CVStats.percentage( results.withRightCommonAncestor, results.withCommonAncestor );
    ...
    console.log(
      ...
      `${percentTop10}\t${percentTop5}\t${percentTop2}\t${percentTop1}\t` );
  }
