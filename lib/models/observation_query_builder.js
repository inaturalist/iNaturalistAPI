...
if ( params.term_id_or_unknown ) {
    if ( params.term_value_id || params.without_term_value_id) {
      const totalQuery = {
          bool: {
                ...
                should: [
                  {
                    bool: {
                      must: [
                        esClient.termFilter( "annotations.controlled_attribute_id.keyword", params.term_id_or_unknown ),
