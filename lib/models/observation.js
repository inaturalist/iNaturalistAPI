...
const Observation = class Observation extends Model {
  ...
  static preloadProjectMembership( obs, options, callback ) {
    if ( !options.userSession || !options.userSession.user_id ) { return void callback( null ); }
    ...
    if ( projectIDs.length === 0 ) { return void callback( null ); }
  ...
  static preloadObservationUserPreferences( obs, callback ) {
    if ( obs.length === 0 ) { return void callback( null ); }
  ...
  static preloadObservationApplications( obs, callback ) {
    ...
    if ( _.isEmpty( applicationIDs ) ) { return void callback( null ); }
  ...
  static preloadObservationPhotos( obs, callback ) {
    ...
    if ( _.isEmpty( obsIDs ) ) { return void callback( null ); }
      ...
      Observation.preloadMinimal( obs, localeOpts, err2 => {
        ...
        Observation.preloadObservationFields( obs, err3 => {
          ...
          ESModel.fetchBelongsTo( withProjects, Project, { source: Project.returnFields }, err4 => {
            ...
            Observation.preloadProjectMembership( obs, localeOpts, err5 => {
              if ( err5 ) { return void callback( err5 ); }
              Observation.preloadObservationUserPreferences( obs, err6 => {
                if ( err6 ) { return void callback( err6 ); }
                Observation.preloadObservationApplications( obs, err7 => {
  ...
  static preloadMinimal( obs, localeOpts, callback ) {
    ...
    ESModel.fetchHasMany( obs, Identification, "observation.id", { modelOptions: { forObs: true } }, err => {
      if ( err ) { return void callback( err ); }
      Observation.preloadProjectObservations( obs, err2 => {
        if ( err2 ) { return void callback( err2 ); }
