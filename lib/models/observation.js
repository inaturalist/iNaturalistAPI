...
var Observation = class Observation extends Model {
  ...
  constructor( attrs, options ) {
    ...
    if ( options.userSession && this.user ) {
      // viewing user is the observer, or project curator
      if ( this.user.id === options.userSession.user_id ||
           ( options.userSession.curated_project_ids &&
             _.intersection( this.project_ids, options.userSession.curated_project_ids ).length > 0 ) ) {
