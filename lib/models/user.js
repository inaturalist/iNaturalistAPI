...
const User = class User extends Model {
  ...
  static async localeDefaults( userID ) {
    const query = squel.select( )
      ...
      .field( "users.site_id" )
      .field( "users.confirmed_at" )
      .field( "users.donorbox_donor_id" )
      .field( "users.donorbox_plan_status" )
      .field( "users.donorbox_plan_type" )
      .field( "users.created_at" )
    ...
    if ( row.donorbox_donor_id
      && row.donorbox_plan_status === "active"
      && row.donorbox_plan_type === "monthly"
    ) {
      defaults.isMonthlySupporter = true;
    }
    if ( row.place_id ) {
