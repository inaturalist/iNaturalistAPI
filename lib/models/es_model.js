...
const ESModel = class ESModel {
  ...
  // taxa are commonly fetched as a belongTo association, defaulting to using
  // taxon.prepareForResponse using the locale options from the incoming request.
  // This method sets reasonable common defaults for loading taxon associations
  static async fetchBelongsToTaxon( req, objects, options = {} ) {
    ...
    await ESModel.fetchBelongsTo( objects, Taxon, taxonOpts );
  }
