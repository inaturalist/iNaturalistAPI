...
const ESModel = class ESModel {
  ...
  static async ancestriesSpeciesByKingdom( req, field, searchMethod, kingdomId ) {
    ...
    const kingdomPromiseResult = { resultTaxonIDs, ancestriesBuckets };
  ...
  static async ancestriesSpeciesCountsFetch( req, field, searchMethod ) {
    ...
    fetchPromises.push( ESModel.ancestriesSpeciesByKingdom( req, field, searchMethod, [47126] ) );
    fetchPromises.push( ESModel.ancestriesSpeciesByKingdom( req, field, searchMethod, [47170] ) );
    fetchPromises.push( ESModel.ancestriesSpeciesByKingdom( req, field, searchMethod, [1] ) );
    fetchPromises.push( ESModel.ancestriesSpeciesByKingdom( req, field, searchMethod, [48222] ) );
    fetchPromises.push( ESModel.ancestriesSpeciesByKingdom( req, field, searchMethod, [67333] ) );
    fetchPromises.push( ESModel.ancestriesSpeciesByKingdom( req, field, searchMethod, [47686] ) );
    fetchPromises.push( ESModel.ancestriesSpeciesByKingdom( req, field, searchMethod, [131236] ) );
    fetchPromises.push( ESModel.ancestriesSpeciesByKingdom( req, field, searchMethod, [151817] ) );
    const fetchData = await Promise.all( fetchPromises );
    fetchData.forEach( f => {
      resultTaxonIDs = resultTaxonIDs.concat( f.resultTaxonIDs );
      ancestriesBuckets = ancestriesBuckets.concat( f.ancestriesBuckets );
    } );
