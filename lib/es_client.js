...
esClient.envelopeFilter = filter => {
  ...
  opts.swlng = parseFloat( _.isNumber( opts.swlng ) ? opts.swlng : -180 );
  opts.swlat = parseFloat( _.isNumber( opts.swlat ) ? opts.swlat : -90 );
  opts.nelng = parseFloat( _.isNumber( opts.nelng ) ? opts.nelng : 180 );
  opts.nelat = parseFloat( _.isNumber( opts.nelat ) ? opts.nelat : 90 );
