...
const util = class util {
  ...
  static filtersOnlyOnID( filters ) {
    ...
    if ( filters && _.size( filters ) === 1 && _.isPlainObject( filters[0] )
      && _.size( filters[0] ) === 1 && filters[0].terms && _.isPlainObject( filters[0].terms )
      && _.size( filters[0].terms ) === 1 && filters[0].terms.id
      && _.isArray( filters[0].terms.id ) && _.size( filters[0].terms.id ) > 0 ) {
