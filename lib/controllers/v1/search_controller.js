...
SearchController.search = async req => {
  ...
  const should = [
    ...
    // match the nested name_autocomplete field in the taxa index, boosting valid names
    {
      constant_score: {
        filter: {
          nested: {
    ...
    // match the nested name_autocomplete field in the taxa index for invalid names
    {
      constant_score: {
        filter: {
          nested: {
