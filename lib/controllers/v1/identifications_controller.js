...
var IdentificationsController = class IdentificationsController {
  ...
  static similarSpecies( req, callback ) {
    ...
    Taxon.findByID( req.query.taxon_id, ( err, taxon ) => {
      ...
      var idQuery = _.assignIn( { }, sharedQuery, {
      ...
      IdentificationsController.speciesCountsWithOptions( speciesCountsReq1, { photos: true }, ( err, rsp1 ) => {
        ...
        IdentificationsController.speciesCountsWithOptions( speciesCountsReq2, { photos: true }, ( err, rsp2 ) => {
          if( err ) { return callback( err ); }
