...
ObservationsController.reqToElasticQueryComponents = ( req, callback ) => {
  ...
  if ( params.first_of_taxon === "true" ) {
    searchFilters.push( { term: { first_of_taxon: true } } );
  } else if ( params.first_of_taxon === "false" ) {
    searchFilters.push( { term: { first_of_taxon: false } } );
  }
