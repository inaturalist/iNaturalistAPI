...
ObservationsController.identifiersCacheWrapper = ( req, callback ) => {
  const fileCacheKey = util.observationSearchRequestCacheKey( req, "identifiersCacheWrapper" );
...
ObservationsController.observersCacheWrapper = ( req, callback ) => {
  const fileCacheKey = util.observationSearchRequestCacheKey( req, "observersCacheWrapper" );
  CachemanCache.cachedOrFetchFile( fileCacheKey, ( ) => {
