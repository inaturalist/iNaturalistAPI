  ...
  static searchCriteria( req, options = { } ) {
    ...
    if ( req.query.lat && req.query.lng ) {
      ...
      if ( req.query.featured ) {
        filters.push( { exists: { field: "featured_at" } } );
        filters.push( { bool: { should: [
  ...
  static search( req, callback ) {
    ...
    esClient.connection.search({
      ...
      body: {
        ...
        _source: _.without( Project.returnFields, "user_ids", "project_observation_rules", "search_parameters", "rule_preferences", "admins" ),
