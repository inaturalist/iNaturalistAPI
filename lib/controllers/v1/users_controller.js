...
const UsersController = class UsersController {
  ...
  static async autocomplete( req ) {
    ...
    const body = ElasticQueryBuilder.buildQuery( {
      ...
      source: { excludes: User.elasticExcludeFields }
    } );
    const response = await esClient.search( "users", { body } );
  ...
  static async placeAndTaxonSubscriptions( req ) {
    ...
    return UsersController.preloadSubscriptionResources( req, response );
  }
