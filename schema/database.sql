...
CREATE FUNCTION postgis_scripts_build_date() RETURNS text
    LANGUAGE sql IMMUTABLE
    AS $$SELECT '2014-07-25 14:23:02'::text AS version$$;
...
--
-- Name: abc; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX abc ON delayed_jobs USING btree (priority, run_at);
